...
const checkFlag = () => {
    ...
    if (
        flag.charAt(0) !==
            String.fromCharCode((((0x39 % 0xc) * 0x9) ^ 0xa) - 0x15) ||
        flag.charAt(1) !==
            String.fromCharCode(
                ((((0x41 % 0x999) * 0xf) % 0x17) + 0x1d) * 0x2
            ) ||
        flag.charAt(2) !==
            String.fromCharCode(
                (((0x35 % 0x6 ^ 0x355) >> 0x5) - 0x1) * 0x3 - 0xa
            ) ||
        flag.charAt(3) !==
            String.fromCharCode(
                (((((0x3d % 0x7 << 0x7) / 0xa) ^ 0x15) * 0x3) % 0x57) - 0xa
            ) ||
        flag.charAt(4) !==
            String.fromCharCode(
                ((((((0x6b % 0x25) * 0x5) ^ 0xfff) >> 0x4) * 0xe) & 0x55) *
                    0x2 -
                    0xd
            ) ||
        flag.charAt(51) !==
            String.fromCharCode(
                (((((((0x71 % 0x14) * 0xdc) / 0x16) << 0x5) / 0x10) >> 0x2) +
                    0x32) ^
                    0xe
            )
    ) {
    ...
    if (
        flag.charCodeAt(5).toString(2) !== "110111" ||
    ...
    if (
        convertAsciiToHex(flag.substring(9, 24)) !==
        "443356334c305033525f3730304c35"
    ) {
        wrongFlag.classList.toggle("flag_status");
        setTimeout(() => wrongFlag.classList.toggle("flag_status"), 4000);
        return false;
    ...
    if (
        flag.charCodeAt(25).toString(8) !== "64" ||
    ...
    if (
        convertAsciiToHex(
            flag.substring(29, 40).split("").reverse().join("")
        ) !== "594b4334485f5233505535"
    ) {
        wrongFlag.classList.toggle("flag_status");
        setTimeout(() => wrongFlag.classList.toggle("flag_status"), 4000);
        return false;
    ...
    if (
        btoa(
            convertAsciiToHex(
                flag.substring(46, 51).split("").reverse().join("")
            )
        ) !== "MzU0YzMwMzAzNw=="
    ) {
        wrongFlag.classList.toggle("flag_status");
